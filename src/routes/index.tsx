...
import { WeatherWidget } from "@/components/hydrotrace/weather-widget";
import { RoutingDiagram } from "@/components/hydrotrace/routing-diagram";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Dashboard | HydroTrace" },
      {
        name: "description",
        content:
          "Live overview of the HydroTrace system: rainwater and RO reject levels, water quality, routing state, savings and recent events.",
      },
      { property: "og:title", content: "Dashboard | HydroTrace" },
      {
